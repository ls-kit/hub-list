...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.service.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <x-admin.input type="text" label="Service Name" name="name" :errors="$errors" />
            ...
            <x-admin.input type="text" label="Service Type" name="type" :errors="$errors" />

            <x-admin.input type="text" label="Service phone" name="phone" :errors="$errors" />

            <x-admin.input type="text" label="Service Provider" name="provider_name" :errors="$errors" />
