...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.person.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <x-admin.input type="text" label="Peson name Name" name="name" :errors="$errors" />
            ...
            <x-admin.input type="text" label="Skilled in" name="skilled_in" :errors="$errors" />
            ...
            <x-admin.input type="text" label="Email" name="email" :errors="$errors" />
